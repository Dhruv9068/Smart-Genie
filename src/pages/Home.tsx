...
import { ArrowRight, Zap, Shield, Globe, Bot, FileText, Bell } from 'lucide-react';
...
export const Home: React.FC = () => {
  ...
  if (user && !user.profile?.interests) {
  ...
  return (
    <div className="min-h-screen bg-cream-50 bg-grid-pattern bg-grid">
      ...
      <div className="relative">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-orange-400 to-orange-800 text-white">
  ...
  onClick={() => window.location.href = '/assistant'}
  size="lg"
  className="text-lg text-black px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-800 hover:bg-gray-100"
>
